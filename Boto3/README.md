...
# Create a new bucket
s3.create_bucket(Bucket='oktay-boto3-bucket')
...
s3.Bucket('oktay-boto3-bucket').put_object(Key='test.jpg', Body=data)
```
- Check the "oktay-boto3-bucket", if your script works fine, you should be able to see your test file in your bucket.
