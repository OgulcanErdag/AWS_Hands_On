...
```bash
while true; do wget -q -O- http://54.197.151.230/; done
```
...
# You can see the log files from this path
...
- Review
  ...
  - Role Description: Ogi Cloudwatch EC2 logs access role
...
Field selection criteria : Account = Your account Number
Select log data to test : i-0418f062d2c4c1fe0 ( ami - change) # Your EC2 Id
